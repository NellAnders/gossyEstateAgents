    ...
    <div class="container">
      ...
      <div class="grid-container-parent">
        ...
        <div class="grid-container">
            ...
            <a class="button" href="./propertiesAddPage.php">Add</a>
            ...
            //   $result = mysqli_query($conn, $sql);
              ...
              if (isset($_POST['submit'])){
                  header("Location: ./properties_searchresults.php?searchterm=".$_POST["searchterm"]);
              }
            ...
            <?php
              ...
              if(mysqli_num_rows($result) > 0){
                  ...
                  echo "No properties have been made";
              }
